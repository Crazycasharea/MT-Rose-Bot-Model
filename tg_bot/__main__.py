        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="❤️HELP❤️", url="https://t.me/{}?start=help".format(bot.username))],
                     [InlineKeyboardButton(text="❤️NEWS❤️", url="t.me/MISSYOUNEWSL"), InlineKeyboardButton(text="❣️MY MASTER❣️", url="t.me/OM_VARADE"), InlineKeyboardButton(text="❣️ ME ❣️", url="t.me/MissYouOfficialBot")],
                     [InlineKeyboardButton(text="❤️Add to group❤️", url="t.me/{}?startgroup=true".format(bot.username)) ]]))
    else:
        update.effective_message.reply_text("i am here")
